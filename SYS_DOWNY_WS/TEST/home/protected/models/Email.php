...
class Email extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, email, content, send_status, create_time, sent_time', 'required'),
			array('user_id, send_status, create_time, sent_time', 'numerical', 'integerOnly'=>true),
			array('email', 'length', 'max'=>85),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, email, content, send_status, create_time, sent_time', 'safe', 'on'=>'search'),
		);
	}
